...
# # Extract month names and year from the Date column
...
#     # -------------------------------
#     # Task 2.3: Add two empty divisions for output graphs
#     # -------------------------------
#     html.Div([
#         html.Div(id='fire-area-graph', style={'width': '48%', 'display': 'inline-block'}),
#         html.Div(id='vegetation-fires-graph', style={'width': '48%', 'display': 'inline-block'})
#     ], style={'display': 'flex', 'justify-content': 'space-between'})
# ])
...
# # -------------------------------
# @app.callback(
#     [Output('fire-area-graph', 'children'),
#      Output('vegetation-fires-graph', 'children')],
#     [Input('region', 'value'),
#      Input('year', 'value')]
# )
...
#     # Filter dataframe by selected region and year
...
#     # Return the plots as children of the respective Divs
...
# Disable SSL verification for this request only (insecure, but fixes cert error)
